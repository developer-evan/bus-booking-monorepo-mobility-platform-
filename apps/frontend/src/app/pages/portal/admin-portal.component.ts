...
@Component({
  ...
  template: `
    <app-portal-shell
      ...
      subtitle="Manage routes, buses, trips, bookings, and staff for your company"
    >
      <div class="rounded-xl border border-neutral-200 bg-white p-6 dark:border-neutral-800 dark:bg-neutral-900">
        ...
        <p class="mt-4 text-neutral-600 dark:text-neutral-300">
          Operator tools (routes, buses, trips, POS bookings) will be built in the next portal phase.
        </p>
      </div>
    </app-portal-shell>
  `,
